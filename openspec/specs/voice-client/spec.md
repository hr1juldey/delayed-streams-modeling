...
Defines the combined Voice Client for full conversation workflows - Speech-to-Text transcription, agent processing, and Text-to-Speech synthesis in a unified interface.
