...
Defines the Text-to-Speech client for synthesizing speech from text via WebSocket. Provides streaming audio output, file export, and configurable voice selection.
