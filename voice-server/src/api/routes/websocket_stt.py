...
from src.api.dependencies import get_websocket_auth
from src.core.exceptions import AuthenticationException, SessionException
from src.models.stt.model_manager import get_stt_model_manager
from src.services.websocket.connection import ConnectionManager
from src.services.websocket.protocol import (
    Message,
    MessageType,
    MessageProtocol,
    TextMessage,
